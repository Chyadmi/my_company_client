 ...
 * @author hamza
 */
public class BoiteDirecteurFXMLController implements Initializable {
    ...
    private void initHelper() {
        try {
            ...
            Logger.getLogger(BoiteDirecteurFXMLController.class.getName()).log(Level.SEVERE, null, ex);
        }
